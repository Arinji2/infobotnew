      ...
      <div className="h-fit md:h-screen w-screen border-b-0 md:border-b-4 md:rounded-lg border-4 border-white flex justify-center p-2 bg">
        <div className={opacity}>
          ...
          <div className="h-fit flex flex-row flex-wrap items-center justify-evenly  w-screen os md:hidden gap-y-5">
            <InfoBox name="Arinjay" role="CEO" icon={Arinji} />
            <InfoBox name="Vedika" role="COO" icon={Vedika} />
            <InfoBox name="Nilay" role="CFO" icon={Nilay} />
            <InfoBox name="Saesha" role="HRM" icon={Saesha} />
            <InfoBox name="Aryan" role="CSO" icon={Aryan} />
            <InfoBox name="Aarav" role="Donator" icon={Aarav} />
            <InfoBox name="Aditya" role="Donator" icon={Aditya} />
            <InfoBox name="Anwesha" role="Head" icon={Anwesha} />
            <InfoBox name="Kunsh" role="Head" icon={Kunsh} />
            <InfoBox name="Aarav" role="Head" icon={Lath} />
            <InfoBox name="Dhanvin" role="Developer" icon={Dhanvin} />
            <InfoBox name="Vedant" role="Developer" icon={Vedant} />
            <InfoBox name="Shreyans" role="Developer" icon={Shreyans} />
            <InfoBox name="Neel" role="Verifier" icon={Neel} />
            <InfoBox name="Shreshth" role="Verifier" icon={Shreshth} />
            <InfoBox name="Rishi" role="Sr Writer" icon={Rishi} />
            <InfoBox name="Siddhartha" role="Writer" icon={Siddhartha} />
            <InfoBox name="Tashvi" role="Writer" icon={Tashvi} />
            <InfoBox name="Yuvraj" role="Writer" icon={Yuvraj} />
            <InfoBox name="Nikhilesh" role="Writer" icon={Nikhilesh} />
          </div>
        </div>
      </div>
      <Footer />
...
function InfoBox({ name, role, icon }) {
  return (
    <div className="w-28  bg-slate-700 p-2 rounded-lg text-center z-50  flex flex-col items-center">
      <img
        src={icon}
        alt={name}
